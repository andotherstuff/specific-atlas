...
export const TYPES = {
  person:      { label: "People",       color: "#e8b04b", glyph: "person" },
  work:        { label: "Works",        color: "#5fb0c9", glyph: "work" },
  place:       { label: "Places",       color: "#7bbf6a", glyph: "place" },
  concept:     { label: "Ideas",        color: "#c47ad0", glyph: "concept" },
  institution: { label: "Institutions", color: "#d98a6a", glyph: "institution" },
  event:       { label: "Moments",      color: "#c9c2b6", glyph: "event" },
};
